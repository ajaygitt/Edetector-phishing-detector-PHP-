...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.php">E DETECTOR - DETECT E BANKING PHISHING WEBSITES</a></h1>
    </div>
...
<div class="wrapper row2">
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      ...
      <li><a class="drop" href="#">VIEW USER</a>
        
      </li>
      <li><a class="drop" href="addweb.php">ADD WEBSITE TO BLACKLIST</a>
          </li>
...
<div class="wrapper row3">
  ...
  <!-- CONTENT AREA -->
    <form action="doaction.php?login=1" method="post" enctype="multipart/form-data">
    <table align="center">
     <tr>
    ...
    <tr>
        ...
        <td><textarea cols="100" rows="4"  name="feed" ></textarea></td>
    </tr>
    <tr>
    	<td colspan="2" align="center"><input type="submit" value="submit feedback"></td>
    </tr>   
   </table>
   </td>
   </tr>
